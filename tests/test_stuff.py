...
def test_fetchcontent_versions():
    ...
    assert deps == {'KDBindings': {'fetchcontent_path': 'cmake/dependencies.cmake'}, 'fmt': {'fetchcontent_path': 'cmake/dependencies.cmake'}, 'spdlog': {'fetchcontent_path': 'cmake/dependencies.cmake'},
                    'whereami': {'fetchcontent_path': 'cmake/dependencies.cmake'}, 'mio': {'fetchcontent_path': 'cmake/dependencies.cmake'}, 'doctest': {'fetchcontent_path': 'tests/CMakeLists.txt'}}
